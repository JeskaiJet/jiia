...
const imgTreeingCaseStudyBanner1 = "https://www.figma.com/api/mcp/asset/50ced89b-724d-4236-9d0e-73f50314e6c5";
        ...
        en: [
          {
            ...
            column: "primary",
            media: {
              src: imgTreeingCaseStudyBanner1,
              alt: "Treeing brand banner",
              width: 420,
              height: 236
            },
            markdown: `Treeing is an invitation-first travel platform.
...
It allows users to find listings from the hosts they are most familiar with.`
          },
          {
            ...
            media: {
              src: imgTreeingCaseStudyBanner1,
              alt: "Treeing product overview banner",
              width: 420,
              height: 236
            },
            markdown: `Treeing is an invitation-first travel platform.

It allows users to find listings from the hosts they are most familiar with. Treeing is an invitation-first travel platform.
...
It allows users to find listings from the hosts they are most familiar with.`
          },
          {
            ...
            media: {
              src: imgTreeingCaseStudyBanner1,
              alt: "Treeing detailed case study banner",
              width: 420,
              height: 236
            },
            markdown: `Treeing is an invitation-first travel platform.
